...
type OrderBookSnapshot struct {
	...
	Symbol       string    `gorm:"size:20;not null;comment:交易对代码，如 BTCUSDT;uniqueIndex:idx_order_book_symbol_update_id,priority:1;index" json:"symbol"`
	LastUpdateID int64     `gorm:"column:last_update_id;not null;comment:盘口快照更新 ID;uniqueIndex:idx_order_book_symbol_update_id,priority:2" json:"last_update_id"`
	...
	EventTime    int64     `gorm:"column:event_time;not null;index;comment:快照事件时间，Unix 毫秒" json:"event_time"`
