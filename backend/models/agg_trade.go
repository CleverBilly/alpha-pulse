...
type AggTrade struct {
	...
	Symbol           string    `gorm:"size:20;not null;comment:交易对代码，如 BTCUSDT;uniqueIndex:idx_agg_trade_symbol_trade_id,priority:1;index" json:"symbol"`
	AggTradeID       int64     `gorm:"column:agg_trade_id;not null;comment:Binance 聚合成交 ID;uniqueIndex:idx_agg_trade_symbol_trade_id,priority:2" json:"agg_trade_id"`
	...
	TradeTime        int64     `gorm:"column:trade_time;not null;index;comment:成交时间，Unix 毫秒" json:"trade_time"`
